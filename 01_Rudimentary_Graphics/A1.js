/**
 * Rudimentary graphics: rudimentary communication between the JavaScript program and the shaders.
 */
...
var u_time = {type: 'i', value: 0};
var u_time0 = {type: 'i', value: 0};
...
function update() {
    ...
    if(u_time0.value < 18) {
        u_time0.value = u_time0.value + 0.25;
